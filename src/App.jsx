          ...
          <div className="sidebar-footer">
            {dealer.logo && (
              <div style={{ marginBottom: 10, textAlign: "center" }}>
                <img src={dealer.logo} alt="Logo" style={{ maxHeight: 56, maxWidth: "100%", objectFit: "contain", mixBlendMode: dealer.logo_blend || "normal", filter: dealer.logo_invert ? "invert(1)" : "none" }} />
              </div>
            )}
